...
def reporteVehiculosTwo(datos, titulo, rutas, kilo, obser):
    global Titulo
    Titulo=titulo
    global tamaño
    tamaño = True
    ...
    pdf.cell(18,7," ",0,0,'C')
    pdf.image(os.path.join(imagenes, rutas['izquierdo'][0] ), 30, 45, 110, 55)
    pdf.cell(5,7," ",0,0,'C')
    pdf.image(os.path.join(imagenes, rutas['frontal'][0]), 150, 45, 110, 55)
    pdf.cell(5,7," ",0,0,'C')
    pdf.image(os.path.join(imagenes, rutas['derecho'][0]), 30, 105, 75, 45)
    pdf.cell(43,7," ",0,0,'C')
    pdf.image(os.path.join(imagenes, rutas['trasera'][0]), 108, 105, 75, 45)
    pdf.cell(5,7," ",0,0,'C')
    pdf.image(os.path.join(imagenes, rutas['interna'][0]), 185, 105, 75, 45)
